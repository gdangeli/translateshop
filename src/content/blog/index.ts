...
\\\`\\\`\\\`
Desktop (DE): "In den Warenkorb legen"
Mobile (DE): Passt

Desktop (FR): "Ajouter au panier"  
Mobile (FR): Passt knapp

Desktop (IT): "Aggiungi al carrello"
...
Der Sprachwechsel gehört:
- In den Header (sticky)
- Mit Flaggen-Icon (schnell erkennbar)
- Als Dropdown (spart Platz)
...
Nehmen Sie Ihr Smartphone und durchlaufen Sie den gesamten Kaufprozess:
- Auf Deutsch
- Auf Französisch
- Auf Italienisch

Notieren Sie jeden Punkt, der nicht optimal ist.

**Schritt 2: Labels kürzen**

\\\`\\\`\\\`
Vorher:
"Lieferadresse eingeben" / "Entrez votre adresse de livraison"

Nachher:
"Lieferadresse" / "Adresse de livraison"
\\\`\\\`\\\`

**Schritt 3: Placeholder statt Labels**

Mobile-freundlicher:
\\\`\\\`\\\`html
<!-- Statt Label über dem Feld -->
<input placeholder="Vorname / Prénom / Nome" />

<!-- Floating Label (noch besser) -->
...
Auf Mobile zählt jedes KB:

\\\`\\\`\\\`html
<img 
  src="placeholder.jpg"
  data-src="produkt.jpg" 
  alt="Produktbild"
  loading="lazy"
/>
\\\`\\\`\\\`
...
Französisch und Italienisch brauchen oft mehr Platz:
...
/* Französisch - etwas kleiner, weil länger */
:lang(fr) .product-title {
  font-size: 15px;
}

/* Italienisch */
:lang(it) .product-title {
  font-size: 15px;
}
\\\`\\\`\\\`
...
**Desktop-Version:**
"Dieses hochwertige Produkt aus 100% Baumwolle wurde in der Schweiz hergestellt und eignet sich perfekt für den Alltag."

**Mobile-Version:**
"100% Baumwolle. Swiss Made. Perfekt für jeden Tag."

## Mobile SEO für mehrsprachige Shops

### Hreflang für Mobile

Google crawlt Mobile-First. Ihre hreflang-Tags müssen stimmen:
